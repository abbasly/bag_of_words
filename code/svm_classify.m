...
for i=1:num_categories
    index = strcmp(categories{i},train_labels);
    model = fitclinear(train_image_feats,index'); %model struct
    confidence = model.Bias + model.Beta'*test_image_feats'; %B + W*X for confidence calculation
